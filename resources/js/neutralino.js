var Neutralino = function(e) {
  ...
  function a() {
    window.NL_TOKEN && sessionStorage.setItem("NL_TOKEN", window.NL_TOKEN), i = new WebSocket(`ws://${window.location.hostname}:${window.NL_PORT}`),
      function() {
        if (Neutralino.events.on("ready", (() => t(this, void 0, void 0, (function*() {
        ...
        Neutralino.events.on("extensionReady", (e => t(this, void 0, void 0, (function*() {
      ...
      function() {
        i.addEventListener("message", (e => {
          ...
          s.id && s.id in o ? ((null === (t = s.data) || void 0 === t ? void 0 : t.error) ? (o[s.id].reject(s.data.error), "NE_RT_INVTOKN" == s.data.error.code && (i.close(), document.body.innerText = "", document.write("<code>NE_RT_INVTOKN</code>: Neutralinojs application configuration prevents accepting native calls from this client."))) : (null === (r = s.data) || void 0 === r ? void 0 : r.success) && o[s.id].resolve(s.data.hasOwnProperty("returnValue") ? s.data.returnValue : s.data), delete o[s.id]) : s.event && n(s.event, s.data)
        })), i.addEventListener("open", (e => t(this, void 0, void 0, (function*() {
          n("ready")
        })))), i.addEventListener("close", (e => t(this, void 0, void 0, (function*() {
          n("serverOffline", {
            code: "NE_CL_NSEROFF",
  ...
  function c(e, t) {
    return new Promise(((n, s) => {
      if ((null == i ? void 0 : i.readyState) != WebSocket.OPEN) return a = {
        method: e,
        data: t,
        resolve: n,
        reject: s
  ...
  var l, f, w = Object.freeze({
    __proto__: null,
    createDirectory: function(e) {
      return c("filesystem.createDirectory", {
        path: e
      })
    },
    removeDirectory: function(e) {
      return c("filesystem.removeDirectory", {
        path: e
      })
    },
    ...
    appendFile: function(e, t) {
      return c("filesystem.appendFile", {
        path: e,
        data: t
      })
    },
    writeBinaryFile: function(e, t) {
      return c("filesystem.writeBinaryFile", {
        path: e,
        data: d(t)
      })
    },
    appendBinaryFile: function(e, t) {
      return c("filesystem.appendBinaryFile", {
        path: e,
        data: d(t)
      })
    },
    readFile: function(e) {
      return c("filesystem.readFile", {
        path: e
      })
    },
    readBinaryFile: function(e) {
      return new Promise(((t, n) => {
        c("filesystem.readBinaryFile", {
          path: e
        }).then((e => {
          let n = window.atob(e),
            i = n.length,
    ...
    removeFile: function(e) {
      return c("filesystem.removeFile", {
        path: e
      })
    },
    readDirectory: function(e) {
      return c("filesystem.readDirectory", {
        path: e
      })
    },
    copyFile: function(e, t) {
      return c("filesystem.copyFile", {
        source: e,
        destination: t
      })
    },
    moveFile: function(e, t) {
      return c("filesystem.moveFile", {
        source: e,
        destination: t
      })
    },
    getStats: function(e) {
      return c("filesystem.getStats", {
        path: e
      })
    }
  });
  ...
  var p = Object.freeze({
    ...
    execCommand: function(e, t) {
      return c("os.execCommand", Object.assign({
        command: e
      }, t))
    },
    spawnProcess: function(e) {
      return c("os.spawnProcess", {
        command: e
      })
    },
    updateSpawnedProcess: function(e, t, n) {
      return c("os.updateSpawnedProcess", {
        id: e,
        event: t,
        data: n
      })
    ...
    showOpenDialog: function(e, t) {
      return c("os.showOpenDialog", Object.assign({
        title: e
      }, t))
    },
    showFolderDialog: function(e) {
      return c("os.showFolderDialog", {
        title: e
      })
    },
    showSaveDialog: function(e, t) {
      return c("os.showSaveDialog", Object.assign({
        title: e
      }, t))
    },
    showNotification: function(e, t, n) {
      return c("os.showNotification", {
        title: e,
        content: t,
        icon: n
      })
  ...
  var N = Object.freeze({
    ...
    restartProcess: function(e) {
      return new Promise((n => t(this, void 0, void 0, (function*() {
        let t = window.NL_ARGS.reduce(((e, t) => e += " " + t), "");
        (null == e ? void 0 : e.args) && (t += " " + e.args), yield Neutralino.os.execCommand(t, {
          background: !0
  ...
  var y = Object.freeze({
    ...
    setIcon: function(e) {
      return c("window.setIcon", {
        icon: e
      })
    },
    move: function(e, t) {
      return c("window.move", {
        x: e,
        y: t
      })
    },
    setDraggableRegion: function(e) {
      return new Promise(((n, i) => {
        ...
        o.addEventListener("pointerdown", c), o.addEventListener("pointerup", u), h.set(o, {
          pointerdown: c,
          pointerup: u
        }), n({
          success: !0,
    ...
    unsetDraggableRegion: function(e) {
      return new Promise(((t, n) => {
        ...
        i.removeEventListener("pointerdown", o), i.removeEventListener("pointerup", r), h.delete(i), t({
          success: !0,
    ...
    setSize: function(e) {
      return new Promise(((n, i) => t(this, void 0, void 0, (function*() {
        let t = yield Neutralino.window.getSize();
        c("window.setSize", e = Object.assign(Object.assign({}, t), e)).then((e => {
          n(e)
        })).catch((e => {
          i(e)
        }))
    ...
    setAlwaysOnTop: function(e) {
      return c("window.setAlwaysOnTop", {
        onTop: e
      })
    },
    create: function(e, t) {
      return new Promise(((n, i) => {
        ...
        t && t.processArgs && (r += " " + t.processArgs), Neutralino.os.execCommand(r, {
          background: !0
        }).then((e => {
          n(e)
        })).catch((e => {
  ...
  var O = Object.freeze({
    ...
    dispatch: function(e, n, i) {
      return new Promise(((o, r) => t(this, void 0, void 0, (function*() {
        let t = yield Neutralino.extensions.getStats();
        if (t.loaded.includes(e))
          if (t.connected.includes(e)) try {
            let t = yield c("extensions.dispatch", {
              extensionId: e,
              event: n,
              data: i
            });
  ...
  var b = Object.freeze({
    ...
    checkForUpdates: function(e) {
      return new Promise(((n, i) => t(this, void 0, void 0, (function*() {
        ...
        try {
          let t = yield fetch(e);
          R = JSON.parse(yield t.text()), ! function(e) {
    ...
    install: function() {
      return new Promise(((e, n) => t(this, void 0, void 0, (function*() {
        if (!R) return n({
          code: "NE_UP_UPDNOUF",
          message: "No update manifest loaded"
        });
        try {
          let t = yield fetch(R.resourcesURL), n = yield t.arrayBuffer();
  ...
  var T = Object.freeze({
    ...
    writeText: function(e) {
      return c("clipboard.writeText", {
        data: e
      })
    }
  });
  let P = !1;
  return e.app = N, e.clipboard = T, e.computer = m, e.debug = _, e.events = E, e.extensions = O, e.filesystem = w, e.init = function() {
    P || (a(), window.NL_ARGS.find((e => "--neu-dev-auto-reload" == e)) && Neutralino.events.on("neuDev_reloadApp", (() => t(this, void 0, void 0, (function*() {
      yield Neutralino.debug.log("Reloading the application..."), location.reload()
    })))), window.NL_CVERSION = "3.5.0", window.NL_CCOMMIT = "2ddbba6eaf458560f4f191d1a67603e365291ac4", P = !0)
  }, e.os = p, e.storage = v, e.updater = b, e.window = y, Object.defineProperty(e, "__esModule", {
    value: !0
  }), e
}({});
